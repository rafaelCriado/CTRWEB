      	<?php 
            ...
            <form name="novo_estado">
                ...
                Descrição:	
                <input type="text" name="novo_estado_nome" placeholder="São Paulo" maxlength="60"  value="<?php echo $row->NOME;?>" >
                <br>
                
                Abreviatura: 			
                <input type="text" name="novo_estado_abreviatura" placeholder="SP" maxlength="2"  value="<?php echo $row->ABREVIATURA;?>" >
                <br>
                
                Código do País: 	
                <input type="text" name="novo_estado_pais" placeholder="5659" maxlength="4"  value="<?php echo $row->CODIGO_PAIS;?>" >
