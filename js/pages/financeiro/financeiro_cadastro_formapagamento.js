...
$('input[name="FC_formapagamento_bt_novo"]').live('click',function(e){
	e.preventDefault();alert('oi');
	limparTodos('form[name="FC_formapagamento"] input');
	$('#financeiro_cadastro_formapagamento').load('financeiro_cadastro_formapagamento.php');
});
// ==========================================================================
						...
						$.getJSON(
							...
							function(j){
								...
								if(codigo_condicao_pagamento != 0){
									$.post(
										'financeiro_cadastro_formapagamento.php',
										{ "condigo_condicao_pagamento": codigo_condicao_pagamento},
										function(data){
											$('#financeiro_cadastro_formapagamento').html(data);
										}
									)
								}
							}
