// Página de Cadastro de Estados
	...
	$('input[name="novo_estado_bt_cadastrar"]').live("click", function(){
	...
	$('a[name="novo_estado_bt_excluir"]').live("click", function(e){
		e.preventDefault();
	...
	//alterar
	$('a[name="novo_estado_bt_alterar"]').live("click",function(e){
		e.preventDefault();
