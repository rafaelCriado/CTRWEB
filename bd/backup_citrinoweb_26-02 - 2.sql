...
-- Created by Usuario on 22/03/2013, 15:11:51 --
------------------------------------------------

spool backup_citrinoweb_26-02 - 2.log
...
comment on table DDW.EMPRESA
  is 'Cadastro de Empresa';
...
comment on column DDW.EMPRESA.USUCOD
  is 'Usuario';
comment on column DDW.EMPRESA.MSG1
  is 'Mensagem 1';
