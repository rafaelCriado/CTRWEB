...
-- Created by Usuario on 22/02/2013, 16:17:58 --
------------------------------------------------

spool backup_citrinoweb_22-02.log
...
BEGIN
  ...
  IF( V_EXISTEPRODUTO = 1 AND V_EXISTETABELA = 1 ) THEN
  ...
  IF( V_EXISTEPRODUTO = 0 AND V_EXISTETABELA = 1) THEN
  ...
  IF( V_EXISTEPRODUTO = 0 AND V_EXISTETABELA = 0) THEN
...
prompt
prompt Creating trigger EMPRESA_CONFIGEMPRESA_BI
prompt =========================================
prompt
CREATE OR REPLACE TRIGGER DDW.EMPRESA_CONFIGEMPRESA_BI
  BEFORE INSERT ON EMPRESA  
  FOR EACH ROW
  
BEGIN
      INSERT INTO CONFIG_EMPRESA VALUES (:NEW.EMPCOD,NULL);  
END EMPRESA_CONFIGEMPRESA_BI;
/
