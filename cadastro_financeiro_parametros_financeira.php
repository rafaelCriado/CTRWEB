<?PHP 
	...
	$acessar = acessaTela(258, $sessao->getNode('usuario_citrino'),'ACESSAR',$conecta);
...
<html>
	<head>
    	<link rel="stylesheet" type="text/css" href="css/pages/cadastro/cadastro_financeiro_parametros.css">
    	<script type="text/javascript" src="js/pages/cadastro/cadastro_financeiro_parametros.js"></script>
    </head>
    
	<body>
        <div id="form_pesquisa_produto" class="k-content" style="height:100%">
            <?php include('php/cadastro/financeiro/parametros/tela.php'); ?>
        </div>
	</body>
</html>
