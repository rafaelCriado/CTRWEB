...
<html>
	<head>
    	<link rel="stylesheet" type="text/css" href="css/pages/cadastro/cadastro_produto_pesquisa.css">
    	<script type="text/javascript" src="js/pages/cadastro/cadastro_produto_pesquisa.js"></script>
    </head>
    
	<body>
        <div id="form_pesquisa_produto" class="k-content" style="height:100%">
            <?php include('php/cadastro/produto_pesquisa/tela_produto.php'); ?>
        </div>
	</body>
</html>
