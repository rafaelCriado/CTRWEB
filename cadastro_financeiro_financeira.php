<?PHP 
	...
	$acessar = acessaTela(257, $sessao->getNode('usuario_citrino'),'ACESSAR',$conecta);
...
<html>
	<head>
    	<link rel="stylesheet" type="text/css" href="css/pages/cadastro/cadastro_financeiro_financeiras.css">
    	<script type="text/javascript" src="js/pages/cadastro/cadastro_financeiro_financeiras.js"></script>
    </head>
    
	<body>
        <div id="form_pesquisa_produto" class="k-content" style="height:100%">
            <?php include('php/cadastro/financeiro/financeiras/tela.php'); ?>
        </div>
	</body>
</html>
